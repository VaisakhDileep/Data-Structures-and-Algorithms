...
Description : This program finds the height of the indexed binary max heap.
*/
...
int handle_height_indexed_binary_max_heap(Indexed_Binary_Max_Heap *heap)
{
    try
    {
        return height_indexed_binary_max_heap(heap);
    }
    catch(string &ex)
    {
        cout<<ex;

...
Date        : 3, March, 2022
Description : This program displays a binary tree using reversed in-order traversal.
*/
...
void display_binary_tree(Node *node) // reversed in-order traversal
{
    if(node != nullptr)
    {

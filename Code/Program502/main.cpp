...
Description : This program deletes an element from the indexed binary max heap.
*/
...
int handle_delete_indexed_binary_max_heap(Indexed_Binary_Max_Heap *heap, int key)
{
    try
    {
        return delete_indexed_binary_max_heap(heap, key);
    }
    catch(string &ex)
    {
        cout<<ex;
...
int main()
{
    ...
    cout<<"handle_delete_indexed_binary_max_heap(idx_bin_max_heap, 1): "<<handle_delete_indexed_binary_max_heap(idx_bin_max_heap, 1)<<"\n";

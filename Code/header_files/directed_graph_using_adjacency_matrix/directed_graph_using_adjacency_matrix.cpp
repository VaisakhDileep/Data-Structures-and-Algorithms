...
Description : Definition file for directed_graph_using_adjacency_matrix.
*/

#include "directed_graph_using_adjacency_matrix.hpp"
...
void DGAM::display_directed_graph(Directed_Graph *d_graph)
{
...
void DGAM::delete_directed_graph(Directed_Graph *d_graph)
{
    if(d_graph == nullptr)
    {
...
void DGAM::handle_delete_directed_graph(Directed_Graph *d_graph)
{
    try
    {
...
void DGAM::add_edge_directed_graph(Directed_Graph *d_graph, Edge edge)
{
    if(d_graph == nullptr)
    {
        throw string {"ERROR - Invalid operation, graph is not valid ....."};
...
void DGAM::handle_add_edge_directed_graph(Directed_Graph *d_graph, Edge edge)
{
    try
    {
...
void DGAM::create_directed_graph(Directed_Graph *d_graph, Edge *edges, int num_edges)
{
    if(d_graph == nullptr)
    {
        throw string {"ERROR - Invalid operation, graph is not valid ....."};
...
void DGAM::handle_create_directed_graph(Directed_Graph *d_graph, Edge *edges, int num_edges)
{
    try
    {

...
int right_child_binary_tree(Binary_Tree *T, int node)
{
	...
	if(T->A == nullptr)
	{
		throw string {"ERROR - Invalid opeation, binary tree is empty ....."};
	}
	...
	{
		throw string {"ERROR - Invalid opertion, no right child present for the node ....."};
	}
	else
	{
		return T->A[i];
...
int main()
{
	...
	cout<<"handle_right_child_binary_tree(T, node): "<<handle_right_child_binary_tree(&T, 1)<<"\n";
	cout<<"handle_right_child_binary_tree(T, node): "<<handle_right_child_binary_tree(&T, 2)<<"\n";
	cout<<"handle_right_child_binary_tree(T, node): "<<handle_right_child_binary_tree(&T, 3)<<"\n";
